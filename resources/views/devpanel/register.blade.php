...
<html>
    ...
    <div class="w-100 h-full flex flex-col justify-center items-center p-4">
        ...
        <form method="POST" class="flex flex-col justify-center items-center gap-5 mt-10 mb-10" action="api/dev-user">
            @csrf
